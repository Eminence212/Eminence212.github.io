(function() {
  ...
  /**
   * Les menus déroulants de la navigation mobile s'activent
   */
  ...
  window.addEventListener('load', () => {
   ...
   /**
   * Effet sur le sous-titre de l'accueil.
   */
    const typed = select('.accueil .sous__titre',false)
    if (typed) {
      let typed_strings = typed.getAttribute('data-typed-items')
      typed_strings = typed_strings.split(',')
      new Typed('.sous__titre', {
